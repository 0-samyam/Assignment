...
# ========== MENU TO RUN PROBLEMS ==========
if __name__ == "__main__":
    problems = {
        1: ("Number between 1-100", problem1),
        2: ("Even or Odd", problem2),
        3: ("Month name from number", problem3),
        4: ("Grading system", problem4),
        5: ("Divisible by 7", problem5),
        6: ("Calculator", problem6),
        7: ("Car loan eligibility", problem7),
        8: ("FizzBuzz", problem8),
        9: ("Vowel or Consonant", problem9),
        10: ("Grade from marks", problem10),
        11: ("Age categorization", problem11),
        12: ("Character type", problem12),
        13: ("Traffic light", problem13),
        14: ("Job eligibility", problem14),
        15: ("Temperature advice", problem15),
        16: ("Menu pricing", problem16),
        17: ("Player selection", problem17),
        18: ("Movie eligibility", problem18),
        19: ("Login checker", problem19),
        20: ("Season from month", problem20),
    }
    
    print("\n" + "="*50)
    print("PYTHON PRACTICE PROBLEMS (1-20)")
    print("="*50)
    ...
    while True:
        try:
            choice = int(input("\nEnter problem number (1-20) or 0 to exit: "))
            if choice == 0:
                print("Goodbye!")
                break
